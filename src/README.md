...
![Screenshot with preview of a service overview dashboard](./img/screenshots/service.png)

![Screenshot with preview of a data center overview dashboard](./img/screenshots/dc.png)

![Screenshot with preview of a database overview dashboard](./img/screenshots/db.png)
...
![Screenshot with a data table showing columns "service", "node", "process", "status"](./img/screenshots/data_example.png)
...
2.  Select your Prometheus data source, select metric "up". Select query type "Instant".
    ...
    ![Screenshot of Prometheus query](./img/screenshots/quickstart-1.png)
...
3.  Add data transformations.
    ...
    ![Screenshot of data transformations](./img/screenshots/quickstart-2.png)

4.  In visualization settings, add grouping by host (**Grouping and layout** > **Resource groups**).

    ![Screenshot of grouping settings](./img/screenshots/quickstart-3.png)

5.  In **Resource** > **ID field**, select "job".

    ![Screenshot of ID field](./img/screenshots/quickstart-4.png)

6.  In **Resource content**, set **Status field** to "up", **Resource display mode** to "Cell with text", **Cell size** to "30".

    ![Screenshot of resource content settings](./img/screenshots/quickstart-5.png)

7.  Add a **field override**, type "Fields with name", select field "up". Override **Value mappings** and **Display name**.

    ![Screenshot of field override](./img/screenshots/quickstart-6.png)
...
1.  Add two other queries for CPU and Memory. If you're using node exporter
    ...
    ![Screenshot of CPU and Memory queries](./img/screenshots/advanced-1.png)

3.  In visualization settings, select data frame with metric "up" as primary (in **Host Overview** > **Data frame**).

    ![Screenshot of data frame settings](./img/screenshots/advanced-2.png)

4.  Go to settings of group "host" and add joins for CPU and Memory. Join by field "host".

    ![Screenshot of group settings](./img/screenshots/advanced-3.png)

    ![Screenshot of adding a join](./img/screenshots/advanced-4.png)

    ![Screenshot of join settings](./img/screenshots/advanced-5.png)
...
6.  Add a **field override** for CPU and Memory. Override "Unit", "Min", "Max", "Display name",
    ...
    ![Screenshot of field overrides for CPU](./img/screenshots/advanced-6.png)
...
![Screenshot of group with CPU metric over a threshold](./img/screenshots/borders-2.png)

1.  Go to group settings and enable **Overrides border color** for every join.

    ![Screenshot of border overrides for join on CPU](./img/screenshots/borders-1.png)
